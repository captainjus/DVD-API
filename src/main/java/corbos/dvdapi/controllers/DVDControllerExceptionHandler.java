...
@ControllerAdvice // indicates the class will assist all controllers in our project
@RestController  //class is able to serve an HTTP response on behalf of a controller
